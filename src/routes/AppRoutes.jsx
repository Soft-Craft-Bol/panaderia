...
const CarritoLista = lazy(() => import("../pages/pedidos/CarritoLista"));
...
const AppRoutes = () => (
    <Routes>
        ...
        <Route path="/roles" element = {<PrivateRoute> <RolesForm /> </PrivateRoute>}/>
        <Route path="/carrito" element = {<PrivateRoute> <CarritoLista /></PrivateRoute>}/>
