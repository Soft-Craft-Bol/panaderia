...
import { getVentasConFactura } from '../service/api';
import { useDebounce } from './useDebounce';

export const useVentasConFactura = (initialFilters = {}) => {
  ...
  const { data, isLoading, isError, error, refetch } = useQuery({
    queryKey: ['ventasConFactura', { ...filters, debouncedCodigoCliente, debouncedCodigoProducto }],
    queryFn: async () => {
      const response = await getVentasConFactura(
        filters.fechaDesde,
        filters.fechaHasta,
